...
import { Hidden, Button, Divider, AppBar, Toolbar, Container, IconButton, Typography } from "@material-ui/core"
    ...
    <div>
      <AppBar className={classes.appBar}  position="static" style={{
        ...
        <Toolbar style={{display:"flex"}} >
          <div maxWidth="md" className={classes.navLeftContainer} style={{
          ...
          {/* {showProperDeviceNabvar(classes)} */}
        </Toolbar>
      </AppBar>
    </div>
  );
}
const showlogInLogOutButts = (classes) => {
  let loggedIn = true
  if(loggedIn) return(
    <>
...
const showProperDeviceNabvar = (classes) =>{
  if (checkMobile()) return (
      <Container className={classes.navRightContainer}>
        <SideDrawer navLinks={navLinks}/>
      </Container>
  )
  return (
    <Container className={classes.navCenterContainer}>
      <MenuLinks navLinks={navLinks}/>
    </Container>
  )
}
